...
some_query = "https://maps.googleapis.com/maps/api/elevation/json?locations=39.7391536%2C-104.9847034&key=" + API_KEY
...
for query_index in range(10):
    ...
    q = "https://maps.googleapis.com/maps/api/elevation/json?locations={}%2C{}&key={}".format(lat, lng, API_KEY)
...
for lat in range(-60, 90, 30):
    for lon in range(180, -180, -30):
        q = "https://maps.googleapis.com/maps/api/elevation/json?locations={}%2C{}&key={}".format(lat, lon, API_KEY)
